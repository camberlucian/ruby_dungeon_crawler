...
OBJECTS = {
    ...
    "container" => [{"name" => "barrel"}, {"name" => "crate"}, {"name" => "chest"}, {"name" => "chest of drawers"}, {"name" => "wooden box"}, {"name" => "reinforced crate"}, {"name" => "shelf"}, {"name" => "credenza"}, {"name" => "coffin"},  {"name" => "burlap sack"}, {"name" => "large sack"}, {"name" => "abandoned pack"}, {"name" => "wardrobe"}, {"name" => "cupboad"}],
